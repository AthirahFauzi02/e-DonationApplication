...
mysql_select_db($database_eDonationApplication, $eDonationApplication);
$query_Recordset4 = "SELECT sum(AmountOfDonation) as Total FROM donationinformation";
$Recordset4 = mysql_query($query_Recordset4, $eDonationApplication) or die(mysql_error());
...
<div class="header">
  <h1 align="left"> <img src="logo.png" width="179" height="128" align="left">e-Donation Application</h1>
...
<div class="row">
  <div class="leftcolumn">
    <div class="card">
      <h2 align="center">DONATION REQUEST REPORT</h2>
...
<input type="submit" name="Submit" id="Submit" value="Submit">
      ...
      <div align="center">
        <p>
          <input type="button" name="Print" id="Print" value="Print this Report" onClick="window.print()"/>
        </p>
      </div>
      <br>
      </p>
