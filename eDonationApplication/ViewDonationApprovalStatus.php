...
<div class="row">
  <div class="leftcolumn">
    <div class="card">
      <h2>DONATION APPROVAL STATUS</h2>
      <form action="" method="get" name="form1" id="form1">
        ...
        <form action="" method="post" name="form2" id="form2">
          <p>
            <label for="ApplicantIDNo">Applicant ID No:<br>
            </label>
            <b> </b>
            <label for="ApprovalStatus"><b><?php echo $row_Recordset1['ApplicantIDNo']; ?></b><br>
              <br>
              Approval Status:<br>
              <b><?php echo $row_Recordset1['ApprovalStatus']; ?></b> <br>
              <br>
              Amount of Donation Approved:
  <br>
            </label>
            </label>        
            <b> RM <?php echo $row_Recordset1['AmountOfDonation']; ?></b></p>
