    ...
    <div class="card">
      ...
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        <table align="left">
          ...
          <tr valign="baseline">
            <td height="52" align="left" nowrap>ApplicantIDNo:<br>
          ...
          <tr valign="baseline">
            <td height="70" align="left" nowrap>ICNo: <br>
            <input type="text" name="ICNo" value="<?php echo htmlentities($row_Recordset1['ICNo'], ENT_COMPAT, ''); ?>" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td height="70" align="left" nowrap>PhoneNo: <br>
            <input type="text" name="PhoneNo" value="<?php echo htmlentities($row_Recordset1['PhoneNo'], ENT_COMPAT, ''); ?>" size="32"></td>
          </tr>
          <tr valign="baseline">
