...
<div class="row">
  <div class="leftcolumn">
    <div class="card">
      <h2 align="center">DONATION REQUEST LIST</h2>
        ...
        <div align="center">
          <table border="1">
            <tr>             
              ...
              <td><div align="center">Update Approval Status</div></td>
            </tr>
            <?php do { ?>
              <tr>
                ...
                <td><div align="center"><?php echo $row_Recordset3['ApprovalStatus']; ?></div></td>
                 <td><div align="center"><a href="UpdateDonationRequestStatus.php?ProgramID=<?php echo $row_Recordset1['ProgramID']; ?>">Update</a></div></td>
              </tr>
